...
import { createMemoryTracker, stopMemoryTracker, getMemorySnapshot, forceGC } from './memoryTracker'
import { createSentEventState, subscribeToEvents, calculateEventTimings } from './eventHandlers'
...
function buildResult(
	...
	const eventTimings = calculateEventTimings(sentState, startTime, totalTimeMs, timeline, verbose)
